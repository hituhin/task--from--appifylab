...
export default function CreatePost({ currentUser, onPostCreated }: CreatePostProps) {
  ...
  return (
    <div className={`_feed_inner_text_area _b_radious6 _padd_b24 _padd_t24 _padd_r24 _padd_l24 _mar_b16 ${styles.wrap}`}>
      <form onSubmit={handleSubmit}>
        <div className="_feed_inner_text_area_box">
          ...
          <div className={`form-floating _feed_inner_text_area_box_form ${styles.formFloating}`}>
            <textarea
        ...
        {showImageUpload && (
          <div className={styles.imageUploadWrap}>
            <ImageUpload
              onImageSelect={(b64) => setImageUrl(b64)}
        ...
        <div className="_feed_inner_text_area_bottom">
          <div className="_feed_inner_text_area_item">
            ...
            <div className={`_feed_inner_text_area_bottom_event _feed_common ${styles.visibilityWrap}`}>
              <select
