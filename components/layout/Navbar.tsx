...
const NOTIFICATIONS = [
  { id: 1, img: '/assets/images/friend-req.png', text: <><span className="_notify_txt_link">Steve Jobs</span> posted a link in your timeline.</>, time: '42 miniutes ago' },
  { id: 2, img: '/assets/images/profile-1.png', text: <>An admin changed the name of the group <span className="_notify_txt_link">Freelacer usa</span> to <span className="_notify_txt_link">Freelacer usa</span></>, time: '42 miniutes ago' },
  { id: 3, img: '/assets/images/friend-req.png', text: <><span className="_notify_txt_link">Steve Jobs</span> posted a link in your timeline.</>, time: '42 miniutes ago' },
  { id: 4, img: '/assets/images/profile-1.png', text: <>An admin changed the name of the group <span className="_notify_txt_link">Freelacer usa</span> to <span className="_notify_txt_link">Freelacer usa</span></>, time: '42 miniutes ago' },
  { id: 5, img: '/assets/images/friend-req.png', text: <><span className="_notify_txt_link">Steve Jobs</span> posted a link in your timeline.</>, time: '42 miniutes ago' },
  { id: 6, img: '/assets/images/profile-1.png', text: <>An admin changed the name of the group <span className="_notify_txt_link">Freelacer usa</span> to <span className="_notify_txt_link">Freelacer usa</span></>, time: '42 miniutes ago' },
]
    ...
    <>
      ...
      <nav className="navbar navbar-expand-lg navbar-light _header_nav _padd_t10">
        <div className="container _custom_container">
          ...
          {/* Bootstrap toggler for mobile collapse */}
          <button
          ...
          <div className="navbar-collapse" id="navbarSupportedContent">
            ...
            <ul className="navbar-nav mb-2 mb-lg-0 _header_nav_list ms-auto _mar_r8">
              ...
              <li className="nav-item _header_nav_item">
                <span
                  ...
                  onClick={() => { setShowNotifyDrop(!showNotifyDrop); setShowProfileDrop(false) }}
                >
                  ...
                  <div id="_notify_drop" className={`_notification_dropdown${showNotifyDrop ? ' show' : ''}`} onClick={e => e.stopPropagation()}>
                    ...
                    <div className="_notifications_drop_box">
                      <div className="_notifications_drop_btn_grp">
                        <button
                          className={notifyTab === 'all' ? '_notifications_btn_link' : '_notifications_btn_link1'}
                          onClick={() => setNotifyTab('all')}
                        >All</button>
                        <button
                          className={notifyTab === 'unread' ? '_notifications_btn_link' : '_notifications_btn_link1'}
            ...
            <div className="_header_nav_profile">
              ...
              <div className="_header_nav_dropdown">
                <p className="_header_nav_para">{currentUser.firstName} {currentUser.lastName}</p>
                <button
                  id="_profile_drop_show_btn"
                  className="_header_nav_dropdown_btn _dropdown_toggle"
                  type="button"
                  onClick={() => { setShowProfileDrop(!showProfileDrop); setShowNotifyDrop(false) }}
                >
              ...
              >
                ...
                <ul className="_nav_dropdown_list">
                  ...
                  {/* Log Out */}
                  <li className="_nav_dropdown_list_item">
                    <a href="#0" className="_nav_dropdown_link" onClick={(e) => { e.preventDefault(); signOut({ callbackUrl: '/login' }) }}>
                      <div className="_nav_drop_info">
                        <span>
      ...
      {/* Dark mode toggle — keep accessible via FeedPage */}
      <button type="button" onClick={onDarkModeToggle} style={{ display: 'none' }} aria-hidden="true" />
    </>
  )
}
